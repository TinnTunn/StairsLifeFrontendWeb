...
async function handlePostProject(btnEl) {
  ...
  return withSubmitLock(btnEl, async () => {
    ...
    const bMinRaw      = parseInt(document.getElementById('pp-budget-min')?.value);
    const bMaxRaw      = parseInt(document.getElementById('pp-budget-max')?.value);
      ...
      <div style="display:grid;gap:14px">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div class="form-group">
            ...
            <input class="form-input" id="edit-budget-min" type="number" value="${budgetMin}" min="10000" max="100000000" step="1000" onblur="this.value=this.value?Math.round(this.value/1000)*1000:''">
          </div>
          <div class="form-group">
            <label class="form-label">Budget Max (Rp)</label>
            <input class="form-input" id="edit-budget-max" type="number" value="${budgetMax}" min="10000" max="100000000" step="1000" onblur="this.value=this.value?Math.round(this.value/1000)*1000:''">
          </div>
        </div>
        <div class="form-group">
...
async function saveProjectEdit(projectId) {
  ...
  const bMinRaw   = parseInt(document.getElementById('edit-budget-min')?.value || '0');
  const bMaxRaw   = parseInt(document.getElementById('edit-budget-max')?.value || '0');
