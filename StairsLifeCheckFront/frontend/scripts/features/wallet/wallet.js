    ...
    <div class="modal-sheet" style="max-width:480px" role="dialog">
      ...
      <div style="display:grid;gap:14px;margin-bottom:18px">
        ...
        <div class="form-group">
          ...
          <input class="form-input" id="wd-amount" type="number" min="${WALLET_MIN}" max="${walletBalance}" step="1000" placeholder="Min Rp ${WALLET_MIN.toLocaleString('id-ID')}" oninput="_updateWithdrawPreview()">
...
function _setWithdrawAmount(amt) {
  ...
  if (el) { el.value = amt; _updateWithdrawPreview(); }
}
...
async function submitWithdraw() {
  ...
  const amountRaw = parseInt(document.getElementById('wd-amount')?.value || '0');
