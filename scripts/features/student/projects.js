    ...
    list.innerHTML = filtered.map(c => {
      ...
      if (isCompleted) {
        ...
        <div class="active-proj-card" style="cursor:pointer;border-left:3px solid var(--teal-dark)"
          onclick="window.currentContractId='${c.id}';window._currentContract=null;goTo('screen-contract-detail');loadContractDetail('${c.id}')">
          ...
          <div style="font-size:12px;color:var(--teal-dark);margin:6px 0 10px;display:flex;align-items:center;gap:6px">
            ...
            Selesai pada ${completedStr}
          </div>
          <div style="display:flex;gap:8px">
            <button class="btn btn-primary btn-sm" style="flex:1"
              onclick="event.stopPropagation();window.currentContractId='${c.id}';window._currentContract=null;goTo('screen-contract-detail');loadContractDetail('${c.id}')">
      ...
      <div class="active-proj-card" style="cursor:pointer"
        ...
        <div class="active-proj-footer">
          ...
          <button class="btn btn-primary btn-sm"
            onclick="event.stopPropagation();window.currentContractId='${c.id}';goTo('screen-deliverable-upload')">
            Upload Hasil
          </button>
        </div>
      </div>`;
